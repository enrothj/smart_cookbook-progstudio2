...
object Muuntaja {
   ...
   */
  private def onkoMassa(s: String): Boolean = if (massat.contains(s)) true else if (tilavuudet.contains(s)) false else throw new Exception("Parametri ei ole tunnistettu mittayksikkö", s) // TODO: poikkeuksen käsittely
